#ifndef CAFFE_POOLING_SIGMOID_CROSS_ENTROPY_LOSS_LAYER_HPP_
#define CAFFE_POOLING_SIGMOID_CROSS_ENTROPY_LOSS_LAYER_HPP_
...
namespace caffe {
	...
	template <typename Dtype>
		class PoolingSigmoidCrossEntropyLossLayer : public LossLayer<Dtype> {
			public:
				explicit PoolingSigmoidCrossEntropyLossLayer(const LayerParameter& param)
				...
				virtual inline const char* type() const { return "PoolingSigmoidCrossEntropyLoss"; }
				virtual inline int ExactNumBottomBlobs() const { return 4; }

			protected:
				/// @copydoc PoolingSigmoidCrossEntropyLossLayer
				...
				Blob<int> max_idx_;
				Blob<int> max_idx_all_;
				Blob<Dtype> pseudo_target_;
				bool is_vis_;
...
#endif  // CAFFE_POOLING_SIGMOID_CROSS_ENTROPY_LOSS_LAYER_HPP_
