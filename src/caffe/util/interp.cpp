...
void caffe_cpu_interp2(const int channels, const Dtype *data1, const int x1,
...
template <typename Dtype, bool packed>
void caffe_cpu_interp2_backward(const int channels, Dtype *data1, const int x1,
...
template <typename Dtype, bool packed>
void caffe_cpu_pyramid2(const int channels, const Dtype *data, const int height,
...
template void caffe_cpu_interp2_backward<float, false>(
    ...
    const int, const int);
template void caffe_cpu_interp2_backward<double, false>(
